...
public class AnalyzerNoDictionaryHandler extends AbstractHandler
{
	...
	{
		log.info("Invoking analyzer without dictionary");
		...
		try {
				...
				json = ma.analyzeWithoutDictionary(log, word, gramGrp);
		} catch (Exception e) {
